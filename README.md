...
Full reasoning + evidence: [`essay_deep_dive.md`](https://github.com/tex-corver/crawl-thesis-share-n-learn/blob/master/essay_deep_dive.md) + [`evaluation_r*/`](https://github.com/tex-corver/crawl-thesis-share-n-learn/tree/master) in the research repo. This plugin is the reusable packaging.
...
cd your-project
mkdir -p .claude
git clone https://github.com/tex-corver/crawl-thesis .claude-tmp
...
git clone https://github.com/tex-corver/crawl-thesis ~/.claude/plugins/crawl-thesis
```
...
```bash
pip install 'scrapling[fetchers]' scrapy 'camoufox[geoip]'
